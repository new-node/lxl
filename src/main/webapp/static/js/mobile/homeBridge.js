...
//			console.log(data);
			...
			//边墩
			var p1=data.gjTStructures[0];
			var p2=data.gjTStructures[data.gjTStructures.length-1];
...
//	}
	...
	if(zeroJson.iswarn==1){//超限
		context.fillStyle = "red";//红色
	}else if(chuliData.iszh>0||(zeroJson.seq >leftmaxseq||zeroJson.seq<rightmaxseq)){
		context.fillStyle = fillcolor;//深蓝色
	}else if(zeroColor == 1 || itemColor == 1){
		context.fillStyle = fillcolor;//深蓝色
...
//							console.log(chaoxianList)
//							console.log(ocedianzuobiao)
